...
* Apply all the CRDs from [here](https://github.com/xuanson2406/machine-controller-manager/tree/master/kubernetes/crds)
* Apply all the deployment, role-related objects from [here](https://github.com/xuanson2406/machine-controller-manager/tree/master/kubernetes/deployment/out-of-tree).
