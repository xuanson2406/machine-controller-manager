...
require (
	...
	k8s.io/kube-openapi v0.0.0-20220803162953-67bda5d908f1 // keep this value in sync with k8s.io/apiserver
...
replace k8s.io/apimachinery => k8s.io/apimachinery v0.22.9
